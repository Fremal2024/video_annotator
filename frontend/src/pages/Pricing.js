  ...
  return (
    <Container maxWidth="lg" sx={{ py: 6 }}>
      ...
      <Alert severity="info" sx={{ mt: 5, maxWidth: 600, mx: 'auto' }}>
        <strong>Demo pricing.</strong> This is a portfolio project — no real
        payments are processed. The Free plan is genuinely free.
      </Alert>
        ...
        <Stack spacing={3}>
          {[
            ...
            },
            {
              ...
              a: 'Any format that modern browsers play: MP4, MOV, WEBM, and most others.',
            },
            {
